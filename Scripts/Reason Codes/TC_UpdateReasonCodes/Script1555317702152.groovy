...
if (HeadingEarningCodes_Expected.equalsIgnoreCase(HeadingEarningCodes_Actual)) {
    WebUI.click(findTestObject('ReasonCodesObjects/Edit_Icon'))
    ...
    WebUI.clearText(findTestObject('ReasonCodesObjects/Input_ID'))
    ...
    WebUI.setText(findTestObject('ReasonCodesObjects/Input_Des'), 'Reason Codes_description..')

    WebUI.click(findTestObject('ReasonCodesObjects/Button_Save'))

    log.logPassed('Headings matched....Updated Reason Codes')
} else {
