...
if (HeadingEarningCodes_Expected.equalsIgnoreCase(HeadingEarningCodes_Actual)) {
    WebUI.click(findTestObject('ReasonCodesObjects/General Search Icon'))

    WebUI.click(findTestObject('ReasonCodesObjects/General Search_Textbox'))

    WebUI.setText(findTestObject('ReasonCodesObjects/General Search_Textbox'), 'TF_ReasonCodes1026')

    WebUI.click(findTestObject('ReasonCodesObjects/General Search Icon'))

    CustomKeywords.'globalkeywords.record.RecordNotFound'()

    log.logPassed('Headings matched....Reason Codes ID is visible')
} else {
