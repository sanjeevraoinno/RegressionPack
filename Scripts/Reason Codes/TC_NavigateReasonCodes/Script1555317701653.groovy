...
String HeadingEarningCodes_Expected = WebUI.getText(findTestObject('ReasonCodesObjects/Panel_Manage Setup'))
...
if (HeadingEarningCodes_Expected.equalsIgnoreCase(HeadingEarningCodes_Actual)) {
    WebUI.click(findTestObject('ReasonCodesObjects/Global Values_Link'))

    WebUI.click(findTestObject('ReasonCodesObjects/ReasonCodes_Link'))

    log.logPassed('Headings matched....Clicked on Reason Codes')
} else {
