...
String HeadingEarningCodes_Expected = WebUI.getText(findTestObject('FixedValueTypesObjects/Panel_Manage Setup'))
...
if (HeadingEarningCodes_Expected.equalsIgnoreCase(HeadingEarningCodes_Actual)) {
    WebUI.click(findTestObject('FixedValueTypesObjects/span_Global Values'))

    WebUI.click(findTestObject('FixedValueTypesObjects/span_Fixed Value Types'))

    log.logPassed('Headings matched....Clicked on Fixed Value Types')
} else {
