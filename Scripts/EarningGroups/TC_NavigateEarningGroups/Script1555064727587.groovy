...
if (HeadingEarningCodes_Expected.equalsIgnoreCase(HeadingEarningCodes_Actual)) {
    WebUI.click(findTestObject('EarningGroupsObjects/span_Global Values'))

    WebUI.click(findTestObject('EarningGroupsObjects/span_Earning Groups'))

    log.logPassed('Headings matched....Clicked on Earning Groups')
} else {
