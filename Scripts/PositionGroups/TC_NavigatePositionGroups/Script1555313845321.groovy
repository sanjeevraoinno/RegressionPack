...
String HeadingEarningCodes_Expected = WebUI.getText(findTestObject('PositionGroupsObjects/Panel_Manage Setup'))
...
if (HeadingEarningCodes_Expected.equalsIgnoreCase(HeadingEarningCodes_Actual)) {
    WebUI.click(findTestObject('PositionGroupsObjects/Global Values_Link'))

    WebUI.click(findTestObject('PositionGroupsObjects/PositionGroups_Link'))

    log.logPassed('Headings matched....Clicked on Position Groups')
} else {
