...
if (HeadingEarningCodes_Expected.equalsIgnoreCase(HeadingEarningCodes_Actual)) {
    WebUI.click(findTestObject('EventTypesObjects/General Search_Icon'))

    WebUI.click(findTestObject('EventTypesObjects/General Search_Textbox'))

    WebUI.setText(findTestObject('EventTypesObjects/General Search_Textbox'), 'TF_EventTypes')

    WebUI.click(findTestObject('EventTypesObjects/General Search_Icon'))

    log.logPassed('Headings matched....Event Types ID is visible')
} else {
