...
WebUI.callTestCase(findTestCase('EventTypes/TC_GeneralSearchEventTypes'), [:], FailureHandling.STOP_ON_FAILURE)
...
if (HeadingEarningCodes_Expected.equalsIgnoreCase(HeadingEarningCodes_Actual)) {
    WebUI.click(findTestObject('EventTypesObjects/Edit_Icon'))
    ...
    WebUI.clearText(findTestObject('EventTypesObjects/Input_ID'))

    WebUI.setText(findTestObject('EventTypesObjects/Input_ID'), 'TF_EventTypes' + timestamp)

    WebUI.clearText(findTestObject('EventTypesObjects/Input_Des'))

    WebUI.setText(findTestObject('EventTypesObjects/Input_Des'), 'Event Types_description..')

    WebUI.click(findTestObject('EventTypesObjects/Button_Save'))

    log.logPassed('Headings matched....Updated Event Types')
} else {
