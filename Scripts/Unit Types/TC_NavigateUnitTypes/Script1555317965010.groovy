...
String HeadingEarningCodes_Expected = WebUI.getText(findTestObject('UnitTypesObjects/Panel_Manage Setup'))
...
if (HeadingEarningCodes_Expected.equalsIgnoreCase(HeadingEarningCodes_Actual)) {
    WebUI.click(findTestObject('UnitTypesObjects/Global Values_Link'))

    WebUI.click(findTestObject('UnitTypesObjects/UnitTypes_Link'))

    log.logPassed('Headings matched....Clicked on Unit Types')
} else {
